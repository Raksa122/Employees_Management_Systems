...
• To store and manage book data using a CSV file. 
...
• Display employee information that is existing information records. 

• Searching employee information by using ID. 

• Updating employee information by using ID. 

• Deleting employee information records by using ID. 
